...
#con <-read.csv("HAED_v01.csv", header=T, dec=".",sep=",")
#everglades_df <- read.csv(con)
everglades_df <-read.csv("HAED_v01_full.csv", header=T, dec=".",sep=",")
...
if (saveAsPng) {  png(file="out/Everglades_elevation.png",width=500,height=500) }
...
if (saveAsPng) {  png(file="out/Everglades_elevationByHabitat.png",width=500,height=500) }
...
if (saveAsPng) {  png(file="out/Everglades_elevationByQuad1.png",width=500,height=500) }
...
if (saveAsPng) {  png(file="out/Everglades_elevationByQuad2.png",width=500,height=750) }
...
if (saveAsPng) {  png(file="out/Everglades_gatorHabitat1.png",width=500,height=500) }
...
if (saveAsPng) {  png(file="out/Everglades_gatorHabitat2.png",width=500,height=500) }
...
if (saveAsPng) {  png(file="out/Everglades_poster.png",width=width,height=height) }
